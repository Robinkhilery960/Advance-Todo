      ...
      <section class="min-h-screen flex items-stretch text-white  ">
        ...
        >
          ...
          <div class="w-full px-24 z-10">
            ...
            <p class="text-2xl my-4">
              ...
              <br /> with Todo App. A task manager and to-do list app with a lot
              of features.
              <br />
            </p>
          </div>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
          <div class="w-full py-6 z-20 flex flex-col items-center">
            <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto " onSubmit={(event)=>{handleSubmit(event)}}>
              <div class="pb-2 pt-4">
                <input
                  type="email" 
                  name="email"
              ...
              <Link to="/dashboard">
                <button class="uppercase block w-full p-4 text-lg rounded-full    focus:outline-none" style={{backgroundColor:"#0395BB"}}>
                 sign in 
                </button>
                </Link>
              </div>
